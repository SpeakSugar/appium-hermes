...
public class DriverUtil {
    ...
    public static boolean isRunning(AppiumDriver driver, String bundleId) {
        ApplicationState appState = ((InteractsWithApps) driver).queryAppState(bundleId);
    ...
    public static void launch(AppiumDriver driver, String bundleId) {
        RetryUtil.call(() -> {
            ...
            Thread.sleep(2000);
            return ((InteractsWithApps) driver).queryAppState(bundleId) == ApplicationState.RUNNING_IN_FOREGROUND;
    ...
    public static void update(AppiumDriver driver, String bundleId, String hermesAppPath) {
        if (((InteractsWithApps) driver).isAppInstalled(bundleId)) {
        ...
        RetryUtil.call(() -> {
            ((InteractsWithApps) driver).installApp(hermesAppPath, new AndroidInstallApplicationOptions().withGrantPermissionsEnabled());
            return true;
